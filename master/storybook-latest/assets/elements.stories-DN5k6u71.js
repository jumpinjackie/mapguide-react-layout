import{l as e}from"./iframe-Be_Le6QH.js";import{t}from"./react-T4JApClb.js";import{t as n}from"./jsx-runtime-Ce5709bw.js";import{i as r}from"./string-BSenxJ_f.js";import{i,n as a,r as o,t as s}from"./dist-Dw0ZiOHc.js";import{t as c}from"./dist-BNmPr1xU.js";var l=e(t()),u=s();function d(){return`application.arrow-left.arrow-right.arrows-horizontal.caret-down.caret-up.chevron-down.chevron-left.chevron-right.chevron-up.cog.comment.comparison.cross.delete.edit.error.folder-close.geosearch.hand.home.info-sign.issue.layer.layers.map.media.menu-closed.menu-open.minus.multi-select.new-layer.path-search.play.plus.print.properties.search.select.small-cross.stop.th.tick.trash.upload.warning-sign.zoom-to-fit`.split(`.`)}var f=`This group documents the abstract UI element layer used across the application.
