...
`}}}},E={render:()=>{if((0,m.select)(`Error type`,[`string`,`Error object`],`string`)===`string`)return(0,g.jsx)(u,{error:`Something went wrong: could not connect to the server.`});let e=window.Error(`Unexpected error occurred`);return e.stack=`Error: Unexpected error occurred
    ...
    at Module._compile (module.js:569)`,(0,g.jsx)(u,{error:e})},name:`Error`},D={render:()=>(0,g.jsx)(v,{locale:(0,m.select)(`Locale`,[`en`,`fr`],`en`)}),name:`Session Expired`},O={render:()=>(0,g.jsx)(y,{}),name:`Powered By MapGuide`},k={render:()=>(0,g.jsxs)(`div`,{style:{position:`relative`,width:400,height:40,background:`#eee`},children:[(0,g.jsx)(f,{loaded:(0,m.number)(`Loaded tiles`,3),loading:(0,m.number)(`Total tiles`,10),color:(0,m.text)(`Color`,`#ff0000`),position:(0,m.select)(`Position`,[`top`,`bottom`],`top`)}),(0,g.jsx)(`div`,{style:{padding:8},children:`Map area (indicator shown above)`})]}),name:`Map Load Indicator (Loading)`},A={render:()=>(0,g.jsxs)(`div`,{style:{position:`relative`,width:400,height:40,background:`#eee`},children:[(0,g.jsx)(f,{loaded:10,loading:10,color:(0,m.text)(`Color`,`#00aa00`),position:(0,m.select)(`Position`,[`top`,`bottom`],`top`)}),(0,g.jsx)(`div`,{style:{padding:8},children:`Map area (indicator hidden – fully loaded)`})]}),name:`Map Load Indicator (Complete)`},j={render:()=>(0,g.jsxs)(`div`,{style:{display:`flex`,gap:8,flexWrap:`wrap`,alignItems:`center`},children:[(0,g.jsx)(a,{spriteClass:`zoom-in`}),(0,g.jsx)(a,{spriteClass:`zoom-out-fixed`}),(0,g.jsx)(a,{spriteClass:`select`}),(0,g.jsx)(a,{spriteClass:`pan`})]}),name:`ImageIcon (sprite)`},M=[{label:`Home`,tooltip:`Go to home view`,svgIconName:`home`,invoke:i(`Home invoked`)},{label:`Search`,tooltip:`Search features`,svgIconName:`search`,invoke:i(`Search invoked`)},{label:`Print`,tooltip:`Print map`,svgIconName:`print`,invoke:i(`Print invoked`)},{isSeparator:!0},{label:`Select`,tooltip:`Select features`,svgIconName:`select`,invoke:i(`Select invoked`)},{label:`Clear`,tooltip:`Clear selection`,svgIconName:`delete`,enabled:!1,invoke:i(`Clear invoked`)}],N=[{label:`Home`,tooltip:`Go to home view`,svgIconName:`home`,invoke:i(`Home invoked`)},{label:`Search`,tooltip:`Search features`,svgIconName:`search`,invoke:i(`Search invoked`)},{label:`Print`,tooltip:`Print map`,svgIconName:`print`,invoke:i(`Print invoked`)},{isSeparator:!0},{label:`Select`,tooltip:`Select features`,svgIconName:`select`,selected:!0,invoke:i(`Select invoked`)},{label:`Clear`,tooltip:`Clear selection`,svgIconName:`delete`,invoke:i(`Clear invoked`)}],P={render:()=>{let e=(0,m.boolean)(`Vertical`,!1),t=(0,m.boolean)(`Hide vertical labels`,!1);return(0,g.jsx)(s,{childItems:M,containerStyle:{height:32,background:`#f0f0f0`},vertical:e,hideVerticalLabels:t})},name:`Toolbar`},F={render:()=>{let e=(0,m.boolean)(`Vertical`,!1),t=(0,m.boolean)(`Hide vertical labels`,!1);return(0,g.jsx)(s,{childItems:N,containerStyle:{height:32,background:`#f0f0f0`},vertical:e,hideVerticalLabels:t})},name:`Toolbar (with selected item)`},I=[{label:`Home`,tooltip:`Home`,svgIconName:`home`,invoke:i(`Home`)},{label:`Search`,tooltip:`Search`,svgIconName:`search`,invoke:i(`Search`)},{label:`Print`,tooltip:`Print`,svgIconName:`print`,invoke:i(`Print`)},{isSeparator:!0},{label:`Select`,tooltip:`Select`,svgIconName:`select`,invoke:i(`Select`)},{label:`Multi`,tooltip:`Multi-select`,svgIconName:`multi-select`,invoke:i(`Multi-select`)},{label:`Clear`,tooltip:`Clear`,svgIconName:`delete`,invoke:i(`Clear`)},{isSeparator:!0},{label:`Layers`,tooltip:`Layers`,svgIconName:`layers`,invoke:i(`Layers`)},{label:`New Layer`,tooltip:`New Layer`,svgIconName:`new-layer`,invoke:i(`New Layer`)},{label:`Properties`,tooltip:`Properties`,svgIconName:`properties`,invoke:i(`Properties`)},{isSeparator:!0},{label:`Map`,tooltip:`Map`,svgIconName:`map`,invoke:i(`Map`)},{label:`GeoSearch`,tooltip:`GeoSearch`,svgIconName:`geosearch`,invoke:i(`GeoSearch`)},{label:`Path`,tooltip:`Path Search`,svgIconName:`path-search`,invoke:i(`Path Search`)},{isSeparator:!0},{label:`Upload`,tooltip:`Upload`,svgIconName:`upload`,invoke:i(`Upload`)},{label:`Edit`,tooltip:`Edit`,svgIconName:`edit`,invoke:i(`Edit`)},{label:`Trash`,tooltip:`Trash`,svgIconName:`trash`,invoke:i(`Trash`)},{label:`Settings`,tooltip:`Settings`,svgIconName:`cog`,invoke:i(`Settings`)}],L={render:()=>(0,g.jsx)(`div`,{style:{width:300,border:`1px solid #ccc`},children:(0,g.jsx)(s,{childItems:I,containerStyle:{height:29,background:`#f0f0f0`}})}),name:`Toolbar (horizontal overflow)`},R={render:()=>(0,g.jsx)(`div`,{style:{height:200,border:`1px solid #ccc`,display:`inline-flex`},children:(0,g.jsx)(s,{childItems:I,containerStyle:{width:29,background:`#f0f0f0`},vertical:!0,hideVerticalLabels:!0})}),name:`Toolbar (vertical overflow)`},z={render:()=>{let[e,t]=h.useState(!0),n=(0,m.text)(`Title`,`My Dialog`),r=(0,m.boolean)(`Enable interaction mask`,!0);return(0,g.jsxs)(`div`,{style:{position:`relative`,width:640,height:480,background:`#ddd`},children:[!e&&(0,g.jsx)(`button`,{onClick:()=>t(!0),style:{margin:8},children:`Open dialog`}),(0,g.jsx)(p,{x:50,y:50,width:320,height:240,title:n,isOpen:e,icon:`info-sign`,locale:`en`,enableInteractionMask:r,onClose:()=>t(!1),onChange:i(`dialog changed`),children:([e,t])=>(0,g.jsxs)(`div`,{style:{width:e,height:t,padding:8},children:[(0,g.jsxs)(`p`,{children:[`Dialog content (`,e,`×`,t,`)`]}),(0,g.jsx)(`p`,{children:`Drag the title bar to move, drag the corners to resize.`})]})})]})},name:`Rnd Modal Dialog`},B={render:()=>{let[e,t]=h.useState({menu1:{open:!0,metrics:{posX:10,posY:40,width:120,height:32},childItems:[{label:`Item One`,invoke:i(`Item One invoked`)},{label:`Item Two`,invoke:i(`Item Two invoked`)},{isSeparator:!0},{label:`Item Three (disabled)`,enabled:!1,invoke:i(`Item Three invoked`)}]}});return(0,g.jsxs)(`div`,{style:{position:`relative`,width:400,height:200,background:`#eee`},children:[(0,g.jsx)(`button`,{style:{position:`absolute`,left:10,top:8},onClick:()=>t(e=>({...e,menu1:{...e.menu1,open:!0}})),children:`Open flyout`}),(0,g.jsx)(b,{flyoutConf:e,locale:`en`,onCloseFlyout:e=>{i(`close flyout`)(e),t(t=>({...t,[e]:{...t[e],open:!1}}))}})]})},name:`Flyout Region`},V={render:()=>(0,g.jsx)(`div`,{style:{width:600,height:400},children:(0,g.jsxs)(w,{vertical:(0,m.boolean)(`Vertical`,!1),secondaryInitialSize:(0,m.number)(`Secondary initial size (px)`,200),onSecondaryPaneSizeChange:i(`secondary pane size changed`),children:[(0,g.jsx)(`div`,{style:{background:`#b3d9ff`,width:`100%`,height:`100%`,padding:8},children:`Primary pane`}),(0,g.jsx)(`div`,{style:{background:`#ffd9b3`,width:`100%`,height:`100%`,padding:8},children:`Secondary pane`})]})}),name:`Splitter Layout`};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  render: () => {
