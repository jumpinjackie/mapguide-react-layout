	...
	function Gi(a, b, c) {
		...
		switch (b.tag) {
				...
				if (null !== a && null != b.stateNode) Di(a, b, c, d, e), a.ref !== b.ref && (b.flags |= 128);
					...
					if (rh(b)) {
						...
						switch (c) {
							...
							case "select":
							case "option": break;
							default: "function" === typeof f.onClick && (d.onclick = jf);
						}
						d = a;
						b.updateQueue = d;
						null !== d && (b.flags |= 4);
						...
						a === kb.html && (a = lb(c));
						a === kb.html ? "script" === c ? (a = g.createElement("div"), a.innerHTML = "<script><\/script>", a = a.removeChild(a.firstChild)) : "string" === typeof d.is ? a = g.createElement(c, { is: d.is }) : (a = g.createElement(c), "select" === c && (g = a, d.multiple ? g.multiple = !0 : d.size && (g.size = d.size))) : a = g.createElementNS(a, c);
						a[wf] = b;
						a[xf] = d;
						Bi(a, b, !1, !1);
						b.stateNode = a;
			...
			case 13:
				...
				if (d || c) b.flags |= 4;
				return null;
			case 4: return fh(), null === a && cf(b.stateNode.containerInfo), null;
	...
	var ck = function(a, b, c) {
		...
		switch (b.tag) {
			...
			case 3:
				...
				return b;
			case 5: return gh(b), null === a && ph(b), d = b.type, e = b.pendingProps, f = null !== a ? a.memoizedProps : null, g = e.children, nf(d, e) ? g = null : null !== f && nf(d, f) && (b.flags |= 16), oi(a, b), fi(a, b, g, c), b.child;
...
//#endregion
export { require_react_dom as a, require_jsx_runtime as i, require_react_is as n, require_react as o, require_react_is$1 as r, require_prop_types as t };

//# sourceMappingURL=react-vendor-debug.js.map