                ...
                <div>
                    ...
                    {(() => {
                        if (this.state.isDragging === true) {
                            return <div className="tooltip" style={{ position: "relative", width: 170, right: 190, top: 28, textAlign: "right" }}>{`Zoom to 1:${this.calculateScaleForPos(this.state.previewPos).toFixed(2)}`}</div>;
                        }
                    })()}
                </div>
            </Draggable>
