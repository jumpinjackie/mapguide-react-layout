...
const PANELS: IAccordionPanelSpec[] = [
    ...
    contentRenderer: (dim: IAccordionPanelContentDimensions) => {
      return (
        <div style={{ width: dim.width, height: dim.height }}>
          Panel One Content ({dim.width}x{dim.height})
        </div>
      );
    },
  },
  {
    ...
    contentRenderer: (dim: IAccordionPanelContentDimensions) => {
      return (
        <div style={{ width: dim.width, height: dim.height }}>
          Panel Two Content ({dim.width}x{dim.height})
        </div>
      );
    },
  },
  {
    ...
    contentRenderer: (dim: IAccordionPanelContentDimensions) => {
      return (
        <div style={{ width: dim.width, height: dim.height }}>
          Panel Three Content ({dim.width}x{dim.height})
        </div>
      );
    },
  },
...
export const Default = () => (
  <Accordion
    ...
    onActivePanelChanged={action("activePanelChanged")}
    panels={PANELS}
  />
);
export const MiddlePanelInitiallyVisible = () => (
  <Accordion
    style={{ width: 250, height: 500 }}
    onActivePanelChanged={action("activePanelChanged")}
    panels={PANELS}
    activePanelId="PanelB"
  />
);
