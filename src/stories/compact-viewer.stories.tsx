...
export const _BasicExampleEPSG4326 = {
    render: () => {
        return <CompactViewer projection="EPSG:4326" initialBBOX={[-180, 90, 180, 90]}>
            <XYZLayer name="OSM" urls={['https://tile.openstreetmap.org/{z}/{x}/{y}.png']} attributions={['(c) OpenStreetMap contributors']} />
        </CompactViewer>
    }
};
...
export const _BasicExampleEPSG3857 = {
    render: () => {
        return <CompactViewer projection="EPSG:3857" initialBBOX={[-20037508.34, -20048966.1, 20037508.34, 20048966.1]}>
            <XYZLayer name="OSM" urls={['https://tile.openstreetmap.org/{z}/{x}/{y}.png']} attributions={['(c) OpenStreetMap contributors']} />
        </CompactViewer>
    }
};
...
export const _VectorLayer = {
    render: () => {
        return <CompactViewer projection="EPSG:3857">
            <XYZLayer name="OSM" urls={['https://tile.openstreetmap.org/{z}/{x}/{y}.png']} attributions={['(c) OpenStreetMap contributors']} />
