...
import { VectorLayerProps } from '../components/compact-map-viewer/layers/vector';

export const TEST_GEOJSON = {
...
export const OSM_URLS = ['https://tile.openstreetmap.org/{z}/{x}/{y}.png'];
export const OSM_ATTRIBUTIONS = ['(c) OpenStreetMap contributors'];
...
export function useClusteredStyle(enabled: boolean) {
